-- CreateEnum
CREATE TYPE "SubscriptionStatus" AS ENUM ('NONE', 'ACTIVE', 'CANCELING', 'PAST_DUE', 'EXPIRED');
...
CREATE TABLE "PlatformSettings" (
    ...
    "manualPaymentCountries" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "manualPaymentContact" TEXT,
...
CREATE TABLE "Plan" (
    ...
    "priceMonthlyMAD" INTEGER,
    "priceAnnualMAD" INTEGER,
...
CREATE TABLE "AdminResetCode" (
    ...
    CONSTRAINT "AdminResetCode_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Driver" (
    ...
    "phone" TEXT,
    "accessCode" TEXT,
    "isOwnerSelf" BOOLEAN NOT NULL DEFAULT false,
    "notes" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE INDEX "AdminResetCode_email_idx" ON "AdminResetCode"("email");

-- CreateIndex
CREATE INDEX "AdminResetCode_ip_createdAt_idx" ON "AdminResetCode"("ip", "createdAt");
