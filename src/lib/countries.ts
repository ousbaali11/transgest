/**
 * Liste de référence des pays (code ISO 3166-1 alpha-2 + nom français),
 * utilisée pour le sélecteur "pays en paiement manuel" dans Admin.
 * Purement une donnée de référence (codes pays stables) — à ne pas
 * confondre avec une quelconque liste de compatibilité Stripe/PayPal, qui
 * elle n'a pas de source fiable unique et reste gérée manuellement par
 * l'admin au fil de l'eau (voir PlatformSettings.manualPaymentCountries).
 */
export const COUNTRIES: { code: string; name: string }[] = [
  ...
  { code: "BJ", name: "Bénin" }, { code: "BT", name: "Bhoutan" }, { code: "BY", name: "Biélorussie" },
  ...
  { code: "CD", name: "Congo (RDC)" }, { code: "KR", name: "Corée du Sud" }, { code: "KP", name: "Corée du Nord" },
  ...
  { code: "SZ", name: "Eswatini" }, { code: "US", name: "États-Unis" }, { code: "ET", name: "Éthiopie" },
  { code: "FJ", name: "Fidji" }, { code: "FI", name: "Finlande" }, { code: "FR", name: "France" },
  { code: "GA", name: "Gabon" }, { code: "GM", name: "Gambie" }, { code: "GE", name: "Géorgie" },
  { code: "GH", name: "Ghana" }, { code: "GR", name: "Grèce" }, { code: "GD", name: "Grenade" },
  { code: "GT", name: "Guatemala" }, { code: "GN", name: "Guinée" }, { code: "GQ", name: "Guinée équatoriale" },
  { code: "GW", name: "Guinée-Bissau" }, { code: "GY", name: "Guyana" }, { code: "HT", name: "Haïti" },
  ...
  { code: "RW", name: "Rwanda" }, { code: "SV", name: "Salvador" }, { code: "WS", name: "Samoa" },
  { code: "SN", name: "Sénégal" }, { code: "RS", name: "Serbie" }, { code: "SC", name: "Seychelles" },
  { code: "SL", name: "Sierra Leone" }, { code: "SG", name: "Singapour" }, { code: "SK", name: "Slovaquie" },
  { code: "SI", name: "Slovénie" }, { code: "SO", name: "Somalie" }, { code: "SD", name: "Soudan" },
  { code: "SS", name: "Soudan du Sud" }, { code: "LK", name: "Sri Lanka" }, { code: "SE", name: "Suède" },
  { code: "CH", name: "Suisse" }, { code: "SR", name: "Suriname" }, { code: "SY", name: "Syrie" },
  { code: "TJ", name: "Tadjikistan" }, { code: "TW", name: "Taïwan" }, { code: "TZ", name: "Tanzanie" },
  { code: "TD", name: "Tchad" }, { code: "CZ", name: "Tchéquie" }, { code: "TH", name: "Thaïlande" },
  { code: "TL", name: "Timor oriental" }, { code: "TG", name: "Togo" }, { code: "TO", name: "Tonga" },
  { code: "TT", name: "Trinité-et-Tobago" }, { code: "TN", name: "Tunisie" }, { code: "TM", name: "Turkménistan" },
  { code: "TR", name: "Turquie" }, { code: "UA", name: "Ukraine" }, { code: "UY", name: "Uruguay" },
